...
//           All
//         </li>
//         <li className="hidden md:inline-flex headerHover">Gift Mode</li>
//         <li className="hidden md:inline-flex headerHover">Father's Day Deal</li>
//         <li className="hidden md:inline-flex headerHover">Home Favourites</li>
//         <li className="hidden md:inline-flex headerHover">Fashion Find</li>
